...
def _load_reuse_heatmap_data(
        datapath: str) -> Tuple[np.ndarray, int, int, float]:
    ...
    if "real time" in desc_line:
        ...
        assert m is not None, \
            "the input file might not be reuse heatmap data file, desc line " + desc_line + "data " + datapath
