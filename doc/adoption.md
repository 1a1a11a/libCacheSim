...
| Man-Made Heuristics Are Dead. Long Live Code Generators! (PolicySmith) — Dwivedula, Saxena, Akella, Chaudhuri, Kim (UT Austin) | HotNets '25 | B | "Our prototype is built on libCacheSim, a high-performance web cache simulator with an event-driven interface." | [ACM DL](https://doi.org/10.1145/3772356.3772413), [arXiv:2510.08803](https://arxiv.org/abs/2510.08803) |
...
| Version | Date | Change |
|---|---|---|
| 1.0.0 | 2026-08-13 | First edition. **14 adoption entries** — 12 research (3 first-party artifacts, 8 third-party works, 1 independent cross-validation) and 2 project-affiliated ecosystem projects — of which **9 are third-party**. Plus 3 first-party distribution channels, which are reach rather than adoption, for **17 sourced rows** total. By evidence class: 5×A, 6×B, 4×C, 3×D (18 assignments over 17 rows — the 3L-Cache row carries both A and B). Repository signals and downstream algorithm adoption are recorded separately and excluded from every count above. |
