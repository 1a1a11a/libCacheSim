...
| Who | What | Class | Evidence | Source |
|---|---|---|---|---|
| Marc Brooker — engineer at Amazon Web Services | Designed a SIEVE-k variant, evaluated it in libCacheSim against real-world traces, and published his implementation as a fork | C + A | "Using the excellent open source libCacheSim I tried SIEVE-2 against SIEVE on a range of real-world traces." and "I've implemented SIEVE-k in a fork of libCacheSim." The fork carries [`Sieve_k.c`](https://raw.githubusercontent.com/mbrooker/libCacheSim/develop/libCacheSim/cache/eviction/Sieve_k.c) (10 KB) in the eviction directory. | [brooker.co.za](https://brooker.co.za/blog/2023/12/15/sieve.html), [mbrooker/libCacheSim](https://github.com/mbrooker/libCacheSim) |
...
| `gws8820` | Fork extending the simulator to two cache levels | A | README: "runs in 2-Level so can set different replacement algorithm and cache size for each level." | [gws8820/2-Level-libCacheSim](https://github.com/gws8820/2-Level-libCacheSim) |
