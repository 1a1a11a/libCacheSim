...
static void test_L2Cache_ORACLE_LOG(gconstpointer user_data) {
  ...
  cache_t *cache =
      create_test_cache("L2Cache-OracleLog", cc_params, reader, NULL);
  ...
  _verify_profiler_results(res, L2Cache_CACHE_SIZE / L2Cache_STEP_SIZE,
...
static void test_L2Cache_ORACLE_ITEM(gconstpointer user_data) {
  ...
  cache_t *cache =
      create_test_cache("L2Cache-OracleItem", cc_params, reader, NULL);
  g_assert_true(cache != NULL);
  cache_stat_t *res = get_miss_ratio_curve_with_step_size(
      reader, cache, L2Cache_STEP_SIZE, NULL, 0, 0, _n_cores());
...
static void test_L2Cache_ORACLE_BOTH(gconstpointer user_data) {
  ...
  cache_t *cache =
      create_test_cache("L2Cache-OracleBoth", cc_params, reader, NULL);
  g_assert_true(cache != NULL);
  cache_stat_t *res = get_miss_ratio_curve_with_step_size(
      reader, cache, L2Cache_STEP_SIZE, NULL, 0, 0, _n_cores());
...
static void test_L2Cache_LEARNED_TRUE_Y(gconstpointer user_data) {
  ...
  cache_t *cache =
      create_test_cache("L2Cache-LearnedTrueY", cc_params, reader, NULL);
  g_assert_true(cache != NULL);
  cache_stat_t *res = get_miss_ratio_curve_with_step_size(
      reader, cache, L2Cache_STEP_SIZE, NULL, 0, 0, _n_cores());
...
static void test_L2Cache_LEARNED_ONLINE(gconstpointer user_data) {
  ...
  cache_t *cache =
      create_test_cache("L2Cache-LearnedOnline", cc_params, reader, NULL);
  g_assert_true(cache != NULL);
  cache_stat_t *res = get_miss_ratio_curve_with_step_size(
      reader, cache, L2Cache_STEP_SIZE, NULL, 0, 0, _n_cores());
...
static void test_L2Cache_SEGCACHE(gconstpointer user_data) {
  ...
  uint64_t miss_cnt_true[] = {2053537, 1502902, 1288417, 1162762};
  ...
  cache_t *cache =
      create_test_cache("L2Cache-Segcache", cc_params, reader, NULL);
  g_assert_true(cache != NULL);
  cache_stat_t *res = get_miss_ratio_curve_with_step_size(
      reader, cache, L2Cache_STEP_SIZE, NULL, 0, 0, _n_cores());
...
int main(int argc, char *argv[]) {
  ...
  g_test_add_data_func("/libCacheSim/cacheAlgo_L2Cache_LEARNED_TRUE_Y", reader,
                       test_L2Cache_LEARNED_TRUE_Y);
  g_test_add_data_func("/libCacheSim/cacheAlgo_L2Cache_LEARNED_ONLINE", reader,
                       test_L2Cache_LEARNED_ONLINE);
  g_test_add_data_func("/libCacheSim/cacheAlgo_L2Cache_ORACLE_LOG", reader,
                       test_L2Cache_ORACLE_LOG);
  g_test_add_data_func("/libCacheSim/cacheAlgo_L2Cache_ORACLE_ITEM", reader,
                       test_L2Cache_ORACLE_ITEM);
  g_test_add_data_func("/libCacheSim/cacheAlgo_L2Cache_ORACLE_BOTH", reader,
                       test_L2Cache_ORACLE_BOTH);
  g_test_add_data_func("/libCacheSim/cacheAlgo_L2Cache_SEGCACHE", reader,
                       test_L2Cache_SEGCACHE);
