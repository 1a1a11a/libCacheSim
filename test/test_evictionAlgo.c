...
static void test_ClockPro(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {96390, 92614, 88911, 85894,
                              82276, 73203, 63728, 57544};
  ...
  g_assert_true(cache != NULL);
  // cache_stat_t *res = simulate_at_multi_sizes_with_step_size(reader, cache,
  // STEP_SIZE, NULL, 0, 0, _n_cores(), false);
  cache_stat_t *res = simulate_at_multi_sizes_with_step_size(
      reader, cache, STEP_SIZE, NULL, 0, 0, _n_cores(), false);
...
static void test_BeladySize(gconstpointer user_data) {
   ...
   * of an object as the object size throughout the trace */
  uint64_t req_cnt_true = 113872, req_byte_true = 4368040448;
  uint64_t miss_cnt_true[] = {74276, 64559, 60307, 56523,
                              54546, 52621, 50580, 48974};
...
static void test_Random(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {92457, 88582, 84459, 80277,
                              76132, 72134, 68230, 64225};
...
static void test_GDSF(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {89070, 84750, 74850, 70490,
                              67923, 64180, 61027, 58721};
...
static void test_LHD(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {90534, 86891, 82334, 77339,
                              71355, 66938, 63677, 61116};
...
static void test_Hyperbolic(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {92924, 89470, 83452, 81234,
                              74544, 71234, 69356, 65338};
...
static void test_LeCaR(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {93374, 89067, 80230, 81526,
                              72159, 67712, 65206, 64541};
...
static void test_SR_LRU(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {90043, 83978, 81482, 77727,
                              72611, 72059, 67836, 65739};
...
static void test_CAR(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {90522, 83605, 78063, 75772,
                              67384, 65687, 64439, 64376};
  uint64_t miss_byte_true[] = {4084188160, 3769425920, 3525660160, 3394717696,
...
static void test_S3FIFO(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {90117, 80915, 75060, 72191,
                              69815, 65542, 60799, 56045};
