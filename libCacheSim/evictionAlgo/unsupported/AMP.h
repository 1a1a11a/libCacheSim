...
//#define AMP_prev(evictionAlgo, x) (AMP_lookup((evictionAlgo), ((struct AMP_page*)x)->block_numer - 1))
//#define AMP_last(evictionAlgo, x) (AMP_lookup((evictionAlgo), ((struct AMP_page*)x)->last_block_numer))
