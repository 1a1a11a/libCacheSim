...
//gboolean PG_add_withsize(cache_t *evictionAlgo, request_t *req) {
//  int i;
//  gboolean ret_val;
//
...
//  ret_val = PG_add(evictionAlgo, req);
//
//  int n = (int)ceil((double)req->size / evictionAlgo->block_size);
//
//  for (i = 0; i < n - 1; i++) {
//    (*(guint64 *)(req->obj_id_ptr))++;
//    PG_add_only(evictionAlgo, req);
//  }
...
//  evictionAlgo->add_only = PG_add_only;
//  evictionAlgo->add_withsize = PG_add_withsize;
