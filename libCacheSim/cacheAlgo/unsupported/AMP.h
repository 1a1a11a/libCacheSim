...
//#define AMP_prev(cacheAlgo, x) (AMP_lookup((cacheAlgo), ((struct AMP_page*)x)->block_numer - 1))
//#define AMP_last(cacheAlgo, x) (AMP_lookup((cacheAlgo), ((struct AMP_page*)x)->last_block_numer))
