...
static bool SFIFO_Merge_remove(cache_t *cache, const obj_id_t obj_id);
...
static void SFIFO_Merge_remove_obj(cache_t *cache, cache_obj_t *obj_to_remove) {
