...
static void LPv1_free(cache_t *cache);
static bool LPv1_get(cache_t *cache, const request_t *req);
static cache_obj_t *LPv1_find(cache_t *cache, const request_t *req,
                              const bool update_cache);
static cache_obj_t *LPv1_insert(cache_t *cache, const request_t *req);
static cache_obj_t *LPv1_to_evict(cache_t *cache, const request_t *req);
static void LPv1_evict(cache_t *cache, const request_t *req);
static bool LPv1_remove(cache_t *cache, const obj_id_t obj_id);
...
static void LPv1_evict(cache_t *cache, const request_t *req) {
  ...
  cache_obj_t *obj_to_evict = LPv1_to_evict(cache, req);
  remove_obj_from_list(&params->q_head, &params->q_tail, obj_to_evict);
  cache_evict_base(cache, obj_to_evict, true);
}

static void LPv1_remove_obj(cache_t *cache, cache_obj_t *obj) {
  LPv1_params_t *params = (LPv1_params_t *)cache->eviction_params;
