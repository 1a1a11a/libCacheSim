...
#ifndef libCacheSim_RESOURCEMEASURE_H
#define libCacheSim_RESOURCEMEASURE_H
...
static inline void print_rusage_diff0(struct rusage r1, struct rusage r2) {
  ...
  printf(
      ...
      "block input %ld - block output %ld, voluntary context switches %ld - "
      "involuntary %ld\n",
...
#endif  // libCacheSim_RESOURCEMEASURE_H
