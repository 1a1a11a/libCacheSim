...
static const char *g_trace_type_name[UNKNOWN_TRACE + 2] = {
    "CSV_TRACE",
    "BIN_TRACE",
    "PLAIN_TXT_TRACE",
    "ORACLE_GENERAL_TRACE",
...
static const char *req_op_str[OP_INVALID + 2] = {"nop",     "get",    "gets",    "set",    "add",  "cas",
                                                 "replace", "append", "prepend", "delete", "incr", "decr",
                                                 "read",    "write",  "update",  "invalid"};

typedef enum { ERR, OK, MY_EOF } rstatus;
static const char *rstatus_str[3] = {"ERR", "OK", "MY_EOF"};
