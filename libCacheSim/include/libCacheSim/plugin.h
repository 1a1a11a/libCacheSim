...
//
///**
// * create a cache handler, using the cache replacement algorithm is baked into libCacheSim
...
//                      common_cache_params_t cc_params, void *cache_specific_params);
//
///**
// * create a cache handler, using the cache replacement algorithm is baked into libCacheSim
// * @param cache_alg_name name of the cache replacement algorithm (case senstive)
...
// */
//cache_t *
//create_cache_internal(const char *const cache_alg_name,
//                               common_cache_params_t cc_params, void *cache_specific_params);
//
//
///**
...
// */
//cache_t *
//create_cache_external(const char *const cache_alg_name,
//                               common_cache_params_t cc_params, void *cache_specific_params);
//
//#ifdef __cplusplus
//}
