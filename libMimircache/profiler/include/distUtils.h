...
#ifndef LIBMIMIRCACHE_DISTUTILS_H
#define LIBMIMIRCACHE_DISTUTILS_H
 ...
 * @param ts                current timestamp
 * @param reuse_dist        the calculated reuse distance (return value)
...
#endif //LIBMIMIRCACHE_DISTUTILS_H
