...
#ifndef LIBMIMIRCACHE_CHAINEDHASHTABLE_H
#define LIBMIMIRCACHE_CHAINEDHASHTABLE_H
 ...
 * @param cache_obj
 */
void chained_hashtable_add_ptr_to_monitoring(hashtable_t* hashtable, cache_obj_t** ptr);
...
#endif //LIBMIMIRCACHE_CHAINEDHASHTABLE_H
