...
// by default, the ghost list size is 10 times the orginal cacheAlgo size
...
typedef struct ARC_params {
  ...
  gint32 ghost_list_factor;  // size(ghost_list)/size(cacheAlgo),
  // by default, the ghost list size is
  // 10 times the orginal cacheAlgo size
